...
def main():
    ...
    for scenario in range(100):
        ...
        for episode in range(100):
            ...
            if terminated or truncated or episode == 99:
                ...
                if dqn.bufferedActions >= 50:  # Train periodically even if buffer isn't full
                    print("Training DQN model...")
                    dqn.train_model(batches=5)
                    
                # Reset for next episode
                observation, info = env.reset()
                total_reward = 0
                
                if episode >= 99:  # Last episode
                    break
                continue
    ...
    print("saving model...")
    torch.save(dqn.predictorNetwork.state_dict(), "modelCache/model_B0")
